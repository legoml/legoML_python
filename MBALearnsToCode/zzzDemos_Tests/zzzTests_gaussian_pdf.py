from numpy import hstack, squeeze, sqrt
from numpy.linalg import det
from numpy.random import randint, randn
from scipy.stats import multivariate_normal
from sympy import symbols, Symbol, pi, exp, log
...
from MBALearnsToCode.Functions.FUNCTIONS___probability_density_functions import\
    gaussian_density_function, gaussian_density
...
p = g({'x': Matrix(x_value), 'y': Matrix(y_value), 'z': Matrix(z_value), 'w': Matrix(w_value),
       ...
       ('cov', 'y', 'w'): Matrix(Syw_value), ('cov', 'z', 'w'): Matrix(Szw_value)})
print(p)
