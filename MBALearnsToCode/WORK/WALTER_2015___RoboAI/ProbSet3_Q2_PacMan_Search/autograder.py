...
from MBALearnsToCode.WORK.WALTER_2015___RoboAI.search import grading, testClasses, projectParams, graphicsDisplay, \
    testParser, textDisplay
import imp
import optparse
import os
import re
import sys
import MBALearnsToCode.WORK.WALTER_2015___RoboAI.search.projectParams
import random
random.seed(0)
try: 
    from MBALearnsToCode.WORK.WALTER_2015___RoboAI.search.pacman import GameState
except:
    pass
...
def runTest(testName, moduleDict, printTestCase=False, display=None):
    import MBALearnsToCode.WORK.WALTER_2015___RoboAI.search.testParser
    import MBALearnsToCode.WORK.WALTER_2015___RoboAI.search.testClasses
...
def getDisplay(graphicsByDefault, options=None):
    ...
    if graphics:
        try:
            import MBALearnsToCode.WORK.WALTER_2015___RoboAI.search.graphicsDisplay
            return graphicsDisplay.PacmanGraphics(1, frameTime=.05)
        except ImportError:
            pass
    import MBALearnsToCode.WORK.WALTER_2015___RoboAI.search.textDisplay
